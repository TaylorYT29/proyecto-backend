<?php
    ...
    $items = $database->select("tb_dish_information","*",["id_dish_categories"=>"2"]);
...
<body>
    ...
    ?>
    <div class="head">
        <h1 class="title-categories">Main</h1>
    </div>

    <div>
        <a class="flecha-derecha" href="./categories-desserts.php"><img src="./imgs/right-arrow.png" alt=""></a>
        <a class="flecha-izquierda" href="./categories-entrees.php"><img src="./imgs/left-arrow.png" alt=""></a>
    </div>

<?php
    ...
    $items = $database->select("tb_dish_information","*",["id_dish_categories"=>"4"]);
...
<body>
    ...
    <div>
        <a class="flecha-derecha" href="./categories-entrees.php"><img src="./imgs/right-arrow.png" alt=""></a>
        <a class="flecha-izquierda" href="./categories-desserts.php"><img src="./imgs/left-arrow.png" alt=""></a>
    </div>
